    ...
    <SafeAreaView style={styles.container} edges={['bottom', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.sectionHeader}>
          <UserCheck size={16} color={COLORS.textPrimary} style={{ marginRight: 6 }} />
        ...
        <View style={[styles.sectionHeader, { marginTop: 24 }]}>
          <History size={16} color={COLORS.textPrimary} style={{ marginRight: 6 }} />
          ...
          <View style={styles.modalContent} onStartShouldSetResponder={() => true}>
            ...
            <View style={{ zIndex: 10 }}>
              ...
              >
                ...
                <ChevronRight size={16} color={COLORS.textSecondary} style={{ transform: [{ rotate: staffDropdownVisible ? '270deg' : '90deg' }] }} />
              </TouchableOpacity>
            ...
            <View style={{ marginTop: 16 }}>
              <Text style={styles.inputLabel}>Effective From (YYYY-MM-DD) *</Text>
            ...
            {!isPermanent && (
              <View style={{ marginTop: 12 }}>
                <Text style={styles.inputLabel}>Effective To (YYYY-MM-DD)</Text>
                <View style={styles.inputBox}>
                  <TextInput
                    style={styles.input}
                    placeholder="YYYY-MM-DD"
